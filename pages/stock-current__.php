...
<div class="card mb-2 shadow-sm">
    ...
    <div class="card-header d-flex justify-content-between align-items-center" style="background-color:#e0eeff;">
        <h6 class="mb-0">Stock Current Tables</h6> <button class="btn btn-sm btn-success me-2" id="DTexportExcel"  style="font-size:0.8rem; line-height:1.2;">Datatable Export Excel</button>
    </div>
        <div class="card-body">
            <!-- Tabel -->
